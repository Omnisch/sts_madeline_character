...
- [ ] **雪球** `Snowball` 罕见
  > 造成6点伤害，抽1张牌。如果角色未处于凌空，获得1张伤口。落脚。
- [ ] **绿泡泡** `Green Booster` 常见 【①/⓪】
  > 落脚。获得4点格挡，本回合你打出下一张冲刺后，抽1张牌。
- [ ] 青云 `Cyan Cloud` 常见 #
  > 落脚。获得6点格挡。无法被冲刺打出。
- [ ] 红云 `Red Cloud` 罕见 #
  > 落脚。获得6点格挡，抽1张技能牌。无法被冲刺打出。消耗。
- [ ] 移动平台 `Moving Platform` 常见
- [ ] 移动方块 `Move Block` 罕见
- [ ] 飓风 `gale` 罕见 ⓪
  > 【保留】对所有敌人给予2层易伤，获得1层虚弱，消耗。
