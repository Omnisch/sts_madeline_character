...
import omnismadeline.powers.DemoDashImplicitPower;
import omnismadeline.util.CardStats;

public class DemoDash extends BaseDashCard {
    public static final String ID = makeID(DemoDash.class.getSimpleName());
    ...
    protected void onUse(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(p, p, new DemoDashImplicitPower(p, 1), 1));
    }
