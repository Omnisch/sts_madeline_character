...
public class AnotherMeImplicitPower extends BasePower {
    public static final String POWER_ID = makeID("AnotherMe");
    private static final PowerType TYPE = PowerType.BUFF;
    private static final boolean TURN_BASED = false;

    public AnotherMeImplicitPower(AbstractCreature owner, int amount) {
